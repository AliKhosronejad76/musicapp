function ArtistsBox(){
    return(
        <div className="flex justify-between py-5 my-6">
...
function Item({ img , artist }){
    return(
        <div className="flex flex-col items-center ">
            <div className="w-[92px] h-[92px] rounded-full transition duration-500 hover:outline-gray-600 hover:outline-dashed hover:outline-2 hover:outline-offset-2 ">
                <a href="">
                    <img src={img} alt={artist} className=" w-full h-full rounded-full" />
                </a>
            </div>
            <a className="mt-4 text-sm">{artist}</a>
        </div>
    )
}
