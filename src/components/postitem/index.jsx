...
function PostItem(){
    return(
        <div className="w-full rounded-xl shadow-2xl px-2 py-4 my-6 flex ">
                ...
                {/* {actions} */}
                    <div className="w-full flex justify-between items-center  mt-10">
                     ...
                     <div className="flex items-center">
                        ...
                        <a href="#" className="flex  items-center mr-4 text-gray-900 duration-400 transition hover:text-gray-700">
